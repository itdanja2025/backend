...
interface Buy{
    // 1) 추상메소드 : 선언부만 있고 구현부{} 없는 메소드 , **구현체가 구현 할 대상 **
    ...
    // 4) private 메소드 : 현재 인터페이스내에서 사용하는 메소드( 오버라이딩 안됨 )
    private void method4(){ }
    private static void method5(){ }
} // inter end
interface Sell{ void method6(); } // inter end

class Customer extends Object implements Buy , Sell { // 상속extends은 1개의클래스 , 구현implements은 여러개인터페이스 가능
